"""Regression checks for the prism-mob-vault-index casebook."""
...
from casebook.harness import assert_expected, prism_mob_vault_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_mob_vault_index_summary(), assert_expected())
